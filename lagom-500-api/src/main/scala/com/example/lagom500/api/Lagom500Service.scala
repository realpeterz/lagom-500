package com.example.lagom500.api
...
object Lagom500Service  {
  val TOPIC_NAME = "greetings"
}

/**
  * The lagom-500 service interface.
  * <p>
  * This describes everything that Lagom needs to know about how to serve and
  * consume the Lagom500Service.
  */
trait Lagom500Service extends Service {

  /**
    * Example: curl http://localhost:9000/api/hello/Alice
    */
  def hello(id: String, from: String): ServiceCall[NotUsed, String]
  ...
  override final def descriptor = {
    ...
    named("lagom-500")
      .withCalls(
        pathCall("/api/hello/:id?from", hello _),
        pathCall("/api/hello/:id", useGreeting _)
      )
      .withTopics(
        topic(Lagom500Service.TOPIC_NAME, greetingsTopic)
