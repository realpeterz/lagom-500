...
/**
  * This is an event sourced entity. It has a state, [[Lagom500State]], which
  ...
  */
class Lagom500Entity extends PersistentEntity {

  override type Command = Lagom500Command[_]
  override type Event = Lagom500Event
  override type State = Lagom500State

  /**
    * The initial state. This is used if there is no snapshotted state to be found.
    */
  override def initialState: Lagom500State = Lagom500State("Hello", LocalDateTime.now.toString)
  ...
  override def behavior: Behavior = {
    case Lagom500State(message, _) => Actions().onCommand[UseGreetingMessage, Done] {
      ...
      case (GreetingMessageChanged(newMessage), state) =>
        ...
        // the event.
        Lagom500State(newMessage, LocalDateTime.now().toString)
...
/**
  ...
  */
case class Lagom500State(message: String, timestamp: String)

object Lagom500State {
  /**
    ...
    */
  implicit val format: Format[Lagom500State] = Json.format
}

/**
  * This interface defines all the events that the Lagom500Entity supports.
  */
sealed trait Lagom500Event extends AggregateEvent[Lagom500Event] {
  def aggregateTag = Lagom500Event.Tag
}

object Lagom500Event {
  val Tag = AggregateEventTag[Lagom500Event]
}

/**
  * An event that represents a change in greeting message.
  */
case class GreetingMessageChanged(message: String) extends Lagom500Event
...
/**
  ...
  */
sealed trait Lagom500Command[R] extends ReplyType[R]
...
/**
  ...
  */
case class UseGreetingMessage(message: String) extends Lagom500Command[Done]
...
/**
  ...
  * person.
  */
case class Hello(name: String) extends Lagom500Command[String]
...
/**
  ...
  * application loader.
  */
object Lagom500SerializerRegistry extends JsonSerializerRegistry {
  override def serializers: Seq[JsonSerializer[_]] = Seq(
    JsonSerializer[UseGreetingMessage],
    JsonSerializer[Hello],
    JsonSerializer[GreetingMessageChanged],
    JsonSerializer[Lagom500State]
  )
}
